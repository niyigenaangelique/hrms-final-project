...
<flux:input type="date" :$invalid :$size :$placeholder :$attributes class:input="!bg-transparent !border-none [@supports(-moz-appearance:none)]:pe-3">
    <x-slot name="iconTrailing">
        <?php if ($clearable): ?>
            <div class="absolute top-0 bottom-0 flex items-center justify-center pe-10 end-0 border-zinc-600 border-b-zinc-700/80  rounded-none  ">
