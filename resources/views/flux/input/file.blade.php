...
$classes = Flux::classes()
    ->add('w-full flex items-center gap-4  h-[2.1rem]   border border-dashed border-zinc-600 border-b-zinc-700/80 !rounded-none')
...
>
    ...
    <flux:button as="div" class="cursor-pointer h-[1.9rem] !bg-gray-200 rounded-none border-none" :$size aria-hidden="true">
        <?php if ($multiple) : ?>
            {!! __('Choose files') !!}
        <?php else : ?>
            {!! __('Choose file') !!}
