...
$classes = Flux::classes()
    ->add('w-full border border-dashed border-zinc-600 border-b-zinc-700/80  rounded-none  block disabled:shadow-none dark:shadow-none')
    ->add('appearance-none') // Without this, input[type="date"] on mobile doesn't respect w-full...
    ->add('focus:outline-none focus:bg-[#e1ebf8]')
    ->add(match ($size) {
        default => 'text-base sm:text-sm py-2  h-[2.1rem] leading-[1.375rem]', // This makes the height of the input 40px (same as buttons and such...)
