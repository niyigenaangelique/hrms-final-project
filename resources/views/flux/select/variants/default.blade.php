...
$classes = Flux::classes()
    ...
    ->add(match ($size) {
        default => ' h-[2.1rem] py-1 text-base sm:text-sm leading-[1.375rem] rounded-none',
        'sm' => 'h-8 py-1.5 text-sm leading-[1.125rem] rounded-none',
        'xs' => 'h-6 text-xs leading-[1.125rem] rounded-none',
    })
    ->add('shadow-xs border border-dashed border-zinc-600 border-b-zinc-700/80')
    ...
    ->add($invalid
        ...
        : 'border border-dashed border-zinc-600 border-b-zinc-700/80  dark:border-white/10'
    )
    ;
@endphp
