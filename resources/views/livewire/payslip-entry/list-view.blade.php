        ...
        <ul role="list">
            @forelse($this->payslipEntries as $index => $snakeModel)
                <li
                    ...
                    wire:click.prevent="dispatchSelectPayslipEntry('{{ $snakeModel->id }}')"
            ...
            @empty
                <li class="text-sm text-gray-500 dark:text-gray-400">No payslip_entry found.</li>
            @endforelse
        </ul>
    </div>
    <!-- Pagination -->
