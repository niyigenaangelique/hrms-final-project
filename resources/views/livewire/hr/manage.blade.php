...
══════════════════════════════════════════════════════ */
        ...
        .mgr-nav-item:not(.active) .mgr-nav-badge {
        ...
        .ov-t-blue .ov-tile-bar {
            background: var(--blue);
        }

        .ov-t-blue .ov-tile-icon {
            background: var(--blue-lt);
        }

        .ov-t-blue .ov-tile-icon svg {
            stroke: var(--blue);
        }

        .ov-t-blue .ov-tile-val {
            color: var(--blue-2);
        }

        .ov-t-green .ov-tile-bar {
            background: var(--green);
        }

        .ov-t-green .ov-tile-icon {
            background: var(--green-lt);
        }

        .ov-t-green .ov-tile-icon svg {
            stroke: var(--green);
        }

        .ov-t-amber .ov-tile-bar {
            background: var(--amber);
        }

        .ov-t-amber .ov-tile-icon {
            background: var(--amber-lt);
        }

        .ov-t-amber .ov-tile-icon svg {
            stroke: var(--amber);
        }

        .ov-t-red .ov-tile-bar {
            background: var(--red);
        }

        .ov-t-red .ov-tile-icon {
            background: var(--red-lt);
        }

        .ov-t-red .ov-tile-icon svg {
            stroke: var(--red);
        }

        .ov-t-indigo .ov-tile-bar {
            background: var(--indigo);
        }

        .ov-t-indigo .ov-tile-icon {
            background: rgba(107, 79, 219, .09);
        }

        .ov-t-indigo .ov-tile-icon svg {
            stroke: var(--indigo);
        }
   ...
   its own CSS just like the standalone pages. */
    ...
    {{-- ══ SIDE NAV ══ --}}
    <aside class="mgr-local-sidebar">
        <nav class="mgr-local-nav">
    ...
    <main class="mgr-local-main">
        ...
        <div class="mgr-section active" id="section-overview">
            ...
            <div class="ov-wrap">
                ...
                <div class="ov-hero">
                    <div class="ov-hero-left">
                        ...
                        <div>
                            ...
                            <div class="ov-hero-sub">{{ \Carbon\Carbon::now('Africa/Kigali')->format('l, j F Y') }}
                                &mdash;
                                Kigali, Rwanda</div>
                    ...
                    <div class="ov-hero-right">
                        <div class="ov-hero-stat">
                            <div class="ov-hero-sv">{{ $empActive }}</div>
                            <div class="ov-hero-sl">Active</div>
                        </div>
                        <div class="ov-hero-stat">
                            <div class="ov-hero-sv">{{ $ctrlActive }}</div>
                            <div class="ov-hero-sl">Contracts</div>
                        </div>
                        <div class="ov-hero-stat">
                            <div class="ov-hero-sv">{{ $deptTotal }}</div>
                            <div class="ov-hero-sl">Depts</div>
                        </div>
                        <div class="ov-hero-stat">
                            <div class="ov-hero-sv">{{ $posTotal }}</div>
                            <div class="ov-hero-sl">Roles</div>
                        </div>
                    </div>
                </div>
                ...
                {{-- Tiles --}}
                <div class="ov-tiles">
                    <div class="ov-tile ov-t-blue"
                        onclick="mgrSwitch('employees',document.querySelector('[data-section=employees]'))">
                        <div class="ov-tile-bar"></div>
                        <div class="ov-tile-icon"><svg viewBox="0 0 24 24">
                                <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />
                                <circle cx="9" cy="7" r="4" />
                                <path d="M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" />
                            </svg></div>
                        <div>
                            <div class="ov-tile-lbl">Total Employees</div>
                            <div class="ov-tile-val">{{ $empTotal }}</div>
                            <div class="ov-tile-sub">{{ $empActive }} active</div>
                        </div>
                    </div>
                    <div class="ov-tile ov-t-green"
                        onclick="mgrSwitch('contracts',document.querySelector('[data-section=contracts]'))">
                        <div class="ov-tile-bar"></div>
                        <div class="ov-tile-icon"><svg viewBox="0 0 24 24">
                                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                                <polyline points="14 2 14 8 20 8" />
                        ...
                        <div>
                            <div class="ov-tile-lbl">Total Contracts</div>
                            <div class="ov-tile-val">{{ $ctrlTotal }}</div>
                            <div class="ov-tile-sub">{{ $ctrlActive }} active</div>
                        </div>
                    </div>
                    <div class="ov-tile ov-t-indigo"
                        onclick="mgrSwitch('departments',document.querySelector('[data-section=departments]'))">
                        <div class="ov-tile-bar"></div>
                        <div class="ov-tile-icon"><svg viewBox="0 0 24 24">
                                <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
                            </svg></div>
                        <div>
                            <div class="ov-tile-lbl">Departments</div>
                            <div class="ov-tile-val">{{ $deptTotal }}</div>
                            <div class="ov-tile-sub">With managers:
                                {{ \App\Models\Department::whereNotNull('manager_id')->count() }}
                            </div>
                        </div>
                    </div>
                    <div class="ov-tile ov-t-amber"
                        onclick="mgrSwitch('positions',document.querySelector('[data-section=positions]'))">
                        <div class="ov-tile-bar"></div>
                        <div class="ov-tile-icon"><svg viewBox="0 0 24 24">
                                <rect x="2" y="7" width="20" height="14" rx="2" />
                                <path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2" />
                        ...
                        <div>
                            <div class="ov-tile-lbl">Positions</div>
                            <div class="ov-tile-val">{{ $posTotal }}</div>
                            <div class="ov-tile-sub">Vacant:
                                {{ \App\Models\Position::doesntHave('employees')->count() }}
                            </div>
                        </div>
                    </div>
                    <div class="ov-tile ov-t-red">
                        ...
                        <div>
                            <div class="ov-tile-lbl">Inactive Staff</div>
                            <div class="ov-tile-val">{{ \App\Models\Employee::where('is_active', false)->count() }}
                            </div>
                            <div class="ov-tile-sub">Needs review</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="ov-grid">
                    ...
                    <div class="ov-col">
                        ...
                        <div class="ov-card">
                            <div class="ov-card-hd">
                                <div class="ov-card-hdl">
                                    <div class="ov-card-ico" style="background:var(--blue-lt);"><svg
                                            style="stroke:var(--blue)" viewBox="0 0 24 24">
                                            <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />
                                            <circle cx="9" cy="7" r="4" />
                                        </svg></div>
                                    <div>
                                        <div class="ov-card-ttl">Recent Employees</div>
                                        <div class="ov-card-sub">Latest additions</div>
                                    </div>
                                </div>
                                <button class="ov-card-lnk"
                                    onclick="mgrSwitch('employees',document.querySelector('[data-section=employees]'))">
                                    View all <svg viewBox="0 0 24 24">
                            ...
                            <div class="ov-card-bd">
                                @forelse($recentEmps as $emp)
                                    ...
                                    <div class="ov-emp-row">
                                        ...
                                        <span class="ov-emp-badge"
                                            style="{{ $isActive ? 'background:var(--green-lt);color:#087A42;' : 'background:var(--red-lt);color:#991B1B;' }}">
                                            {{ $isActive ? 'Active' : 'Inactive' }}
                                        </span>
                                    </div>
                                @empty
                                    <div style="text-align:center;padding:28px;color:var(--ink4);font-size:13px;">No
                                        employees
                                        yet</div>
                                @endforelse
                            </div>
                        ...
                        <div class="ov-card">
                            <div class="ov-card-hd">
                                <div class="ov-card-hdl">
                                    <div class="ov-card-ico" style="background:rgba(107,79,219,.09);"><svg
                                            style="stroke:var(--indigo)" viewBox="0 0 24 24">
                                            <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
                                        </svg></div>
                                    <div>
                                        <div class="ov-card-ttl">Departments by Headcount</div>
                                        <div class="ov-card-sub">Employee distribution</div>
                                    </div>
                                </div>
                                <button class="ov-card-lnk"
                                    onclick="mgrSwitch('departments',document.querySelector('[data-section=departments]'))">
                                    Manage <svg viewBox="0 0 24 24">
                                        <polyline points="9 18 15 12 9 6" />
                                    </svg>
                                </button>
                            </div>
                            <div class="ov-card-bd">
                                @forelse($depts as $i => $dept)
                                    <div class="ov-dept-row">
                                        <div class="ov-dept-dot"
                                            style="background:{{ $deptColors[$i % count($deptColors)] }};box-shadow:0 0 0 3px {{ $deptColors[$i % count($deptColors)] }}28;">
                                        </div>
                                        <div class="ov-dept-name">{{ $dept->name }}</div>
                                        <div class="ov-dept-count">{{ $dept->employees_count }} staff</div>
                                    </div>
                                @empty
                                    <div style="text-align:center;padding:24px;color:var(--ink4);font-size:13px;">No
                                        departments
                                        yet</div>
                                @endforelse
                            </div>
                    ...
                    <div class="ov-col">
                        ...
                        <div class="ov-card">
                            <div class="ov-card-hd">
                                <div class="ov-card-hdl">
                                    <div class="ov-card-ico" style="background:var(--green-lt);"><svg
                                            style="stroke:var(--green)" viewBox="0 0 24 24">
                                            <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" />
                                        </svg></div>
                                    <div>
                                        <div class="ov-card-ttl">Quick Actions</div>
                                    </div>
                                </div>
                            </div>
                            <div class="ov-card-bd">
                                <button class="ov-action"
                                    onclick="mgrSwitch('employees',document.querySelector('[data-section=employees]'))">
                                    <div class="ov-action-icon" style="background:var(--blue-lt);"><svg
                                            style="stroke:var(--blue)" viewBox="0 0 24 24">
                                            <line x1="12" y1="5" x2="12" y2="19" />
                                            <line x1="5" y1="12" x2="19" y2="12" />
                                        </svg></div>
                                    <div>
                                        <div class="ov-action-lbl">Add Employee</div>
                                        <div class="ov-action-sub">Register a new staff member</div>
                                    </div>
                                    <svg class="ov-action-arr" viewBox="0 0 24 24">
                                        <polyline points="9 18 15 12 9 6" />
                                    </svg>
                                </button>
                                <button class="ov-action"
                                    onclick="mgrSwitch('contracts',document.querySelector('[data-section=contracts]'))">
                                    <div class="ov-action-icon" style="background:var(--green-lt);"><svg
                                            style="stroke:var(--green)" viewBox="0 0 24 24">
                                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                                            <polyline points="14 2 14 8 20 8" />
                                        </svg></div>
                                    <div>
                                        <div class="ov-action-lbl">New Contract</div>
                                        <div class="ov-action-sub">Create employment contract</div>
                                    </div>
                                    <svg class="ov-action-arr" viewBox="0 0 24 24">
                                        <polyline points="9 18 15 12 9 6" />
                                    </svg>
                                ...
                                <button class="ov-action"
                                    onclick="mgrSwitch('departments',document.querySelector('[data-section=departments]'))">
                                    <div class="ov-action-icon" style="background:rgba(107,79,219,.09);"><svg
                                            style="stroke:var(--indigo)" viewBox="0 0 24 24">
                                            <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
                                        </svg></div>
                                    <div>
                                        <div class="ov-action-lbl">Add Department</div>
                                        <div class="ov-action-sub">Create a new department</div>
                                    </div>
                                    <svg class="ov-action-arr" viewBox="0 0 24 24">
                                        <polyline points="9 18 15 12 9 6" />
                                    </svg>
                                ...
                                <button class="ov-action"
                                    onclick="mgrSwitch('positions',document.querySelector('[data-section=positions]'))">
                                    <div class="ov-action-icon" style="background:var(--amber-lt);"><svg
                                            style="stroke:var(--amber)" viewBox="0 0 24 24">
                                            <rect x="2" y="7" width="20" height="14" rx="2" />
                                            <path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2" />
                                        </svg></div>
                                    <div>
                                        <div class="ov-action-lbl">Add Position</div>
                                        <div class="ov-action-sub">Define a new job role</div>
                                    </div>
                                    <svg class="ov-action-arr" viewBox="0 0 24 24">
                                        <polyline points="9 18 15 12 9 6" />
                                    </svg>
                        ...
                        <div class="ov-card">
                            <div class="ov-card-hd">
                                <div class="ov-card-hdl">
                                    <div class="ov-card-ico" style="background:var(--teal-lt);"><svg
                                            style="stroke:var(--teal)" viewBox="0 0 24 24">
                                            <line x1="18" y1="20" x2="18" y2="10" />
                                            <line x1="12" y1="20" x2="12" y2="4" />
                                            <line x1="6" y1="20" x2="6" y2="14" />
                                        </svg></div>
                                    <div>
                                        <div class="ov-card-ttl">Summary</div>
                                        <div class="ov-card-sub">At a glance</div>
                                    </div>
                                </div>
                            </div>
                            <div class="ov-card-bd">
                                ...
                                @foreach($rows as [$lbl, $val, $color])
                                    <div
                                        ...
                                        <span
                                            style="font-family:'Sora',sans-serif;font-size:15px;font-weight:800;color:{{ $color }};">{{ $val }}</span>
                                    </div>
                                @endforeach
    ...
    <script>
        function mgrSwitch(name, btnEl) {
            ...
            var content = document.querySelector('.mgr-local-main');
