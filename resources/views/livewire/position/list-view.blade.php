<div
    ...
    <flux:heading size="lg" class="!text-primary-900 mx-auto">List of Positions</flux:heading>
    ...
    <div wire:poll class="w-full !p-0 flex-grow max-w-md bg-white border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <ul role="list">
            @forelse($this->positions as $index => $snakeModel)
                <li
                    ...
                    wire:click.prevent="dispatchSelectPosition('{{ $snakeModel->id }}')"
                    wire:key="{{ $snakeModel->id }}"
                >
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <flux:icon.bars-4 variant="solid"/>
                        </div>
            ...
            @empty
                <li class="text-sm text-gray-500 dark:text-gray-400">No position found.</li>
            @endforelse
        </ul>
    </div>
    <!-- Pagination -->
    <div wire:key="positions-pagination">
