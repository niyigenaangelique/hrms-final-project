...
class ListView extends Component
{
    ...
    #[Computed]
    #[On('reload-page')]
    public function authorizedOvertimes()
    {
        return AuthorizedOvertime::query()
    ...
    public function dispatchSelectAuthorizedOvertime($id): void
    {
        $this->selectedId=$id;
        $this->dispatch('authorizedOvertime-selected', ['id' => $id]);
    }
    public function render():object
    {
        return view('livewire.authorized-overtime.list-view');
    }
}
