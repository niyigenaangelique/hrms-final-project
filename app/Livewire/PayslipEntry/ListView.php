...
class ListView extends Component
{
    ...
    #[Computed]
    #[On('reload-page')]
    public function payslipEntries()
    {
        return PayslipEntry::query()
    ...
    public function dispatchSelectPayslipEntry($id): void
    {
        $this->selectedId=$id;
        $this->dispatch('payslipEntry-selected', ['id' => $id]);
    }
    public function render():object
    {
        return view('livewire.payslip-entry.list-view');
    }
}
