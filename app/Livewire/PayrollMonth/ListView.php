...
class ListView extends Component
{
    ...
    public function dispatchSelectPayrollMonth($id): void
    {
        $this->selectedId=$id;
        $this->dispatch('payrollMonth-selected', ['id' => $id]);
    }
    public function render():object
    {
        return view('livewire.payroll-month.list-view');
    }
}
